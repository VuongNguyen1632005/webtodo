...
-- ?ng d?ng: Web Todo - Qu?n lý d? án cá nhân
-- Ngày t?o: Auto-generated from Entity Framework
-- ============================================
...
-- ============================================
-- 6. B?NG M?C TIÊU (Checklist Items)
-- ============================================
...
-- ============================================
-- 7. B?NG THÀNH VIÊN B?NG (Board Members)
-- ============================================
...
-- ============================================
-- 8. B?NG NHÃN C?A B?NG (Board Labels)
-- ============================================
...
-- ============================================
-- 9. B?NG NHÃN C?A TH? (Card Labels - Many-to-Many)
-- ============================================
...
-- ============================================
-- 10. B?NG THÀNH VIÊN C?A TH? (Card Members - Many-to-Many)
-- ============================================
...
BEGIN
    ...
    PRINT N'?ã t?o b?ng ThanhVienCuaThe';
END
GO
...
PRINT N'?ã t?o các Index';
GO

-- ============================================
-- D? LI?U M?U (OPTIONAL - Có th? b? qua)
-- ============================================

-- T?o tài kho?n admin m?u (password: 123456)
-- L?u ý: Trong th?c t? c?n hash password
...
BEGIN
    ...
    PRINT N'?ã t?o tài kho?n admin m?u';
END
GO
...
BEGIN
    ...
    VALUES (@AdminId, N'D? án m?u', '#0079bf');
    
    DECLARE @BangId INT = SCOPE_IDENTITY();
    
    -- T?o các c?t m?c ??nh
    INSERT INTO Cot (MaBang, TenCot, ThuTu, KichHoat) VALUES (@BangId, N'C?n làm', 0, 1);
    INSERT INTO Cot (MaBang, TenCot, ThuTu, KichHoat) VALUES (@BangId, N'?ang làm', 1, 1);
    INSERT INTO Cot (MaBang, TenCot, ThuTu, KichHoat) VALUES (@BangId, N'?ã xong', 2, 1);
    ...
    INSERT INTO NhanCuaBang (MaBang, TenHienThi, MaMau) VALUES (@BangId, N'Bình th??ng', '#61bd4f');
    
    PRINT N'?ã t?o d? li?u m?u';
END
GO
...
PRINT N'';
PRINT N'========================================';
PRINT N'T?O DATABASE THÀNH CÔNG!';
PRINT N'========================================';
